...
class RegisterAPI(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        root_directory = Directory(name_directory='/', size_directory=0, user_upload=user, pathDestination='/', pathSource='/')
        root_directory.save()

        newProfile = Profile(user=user, is_active=False, root_directory=root_directory)
        newProfile.save()
...
class LogoutAPI(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        """
            ...
            return response HTTP 200 OK
        """
        print('request.headers["Authorization"]1', request.headers["Authorization"])
